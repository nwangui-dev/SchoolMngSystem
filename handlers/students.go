...
func GetStudents(c echo.Context) error {
	// Extract user claims stored in context by JWT middleware
	user := c.Get("user").(*jwt.Token)
	claims := user.Claims.(*JwtCustomClaims) // Directly accessible without package prefix

	_ = claims.Email // Use user email for filtering or auditing
